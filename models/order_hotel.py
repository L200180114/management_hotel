...
class OrderHotel(models.Model):
    ...
    _description = 'Model for order hotel'

    name = fields.Many2one('res.partner', string='Nama Pemesan', required=True, domain="[('is_custommer','=',True)]")
...
class DetailOrder(models.Model):
    ...
    _description = 'Detail Order Room'
    ...
    harga = fields.Integer(compute='_compute_no_kamar', string='Harga/malam')
